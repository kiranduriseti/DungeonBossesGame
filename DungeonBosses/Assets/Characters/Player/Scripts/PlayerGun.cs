...
public class PlayerGun : MonoBehaviour
{
    ...
    [SerializeField] private float startingAmmo = 20f;

    [SerializeField] private float maxAmmo = 20f;

    [FormerlySerializedAs("pickupAmmo")]
    [SerializeField] private float pickupAmmoAmount = 2f;
    ...
    public float GetStartingAmmo() => startingAmmo;
    public float GetMaxAmmo() => maxAmmo;
    public float GetPickupAmmoAmount() => pickupAmmoAmount;
